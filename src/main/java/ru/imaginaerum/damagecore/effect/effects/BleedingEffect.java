...
import ru.imaginaerum.damagecore.library_damage.Bleeding_1_DamageSource;
...
public class BleedingEffect extends MobEffect {
    ...
    public void applyEffectTick(LivingEntity entity, int amplifier) {
        ...
        if (registry.isPresent()) {
            var damageTypeHolder = registry.get().getHolder(DamageTypesGenerator.BLEEDING_1);
            ...
            if (damageTypeHolder.isPresent()) {
                ...
                DamageSource damageSource = new Bleeding_1_DamageSource(damageTypeHolder.get(), sourceEntity);
